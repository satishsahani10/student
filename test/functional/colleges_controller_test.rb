...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { address: @college.address, name: @college.name, university_id: @college.university_id }
    end
  ...
  test "should update college" do
    put :update, id: @college, college: { address: @college.address, name: @college.name, university_id: @college.university_id }
    assert_redirected_to college_path(assigns(:college))
  end
